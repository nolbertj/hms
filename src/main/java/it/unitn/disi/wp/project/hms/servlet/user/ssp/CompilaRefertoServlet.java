 ...
 */
@WebServlet(
    name = "erogaEsameServlet", urlPatterns = {"/areaPrivata/ssp/operazioni/compilaReferto.html"},
...
public class CompilaRefertoServlet extends FactoryServlet {
    ...
    static public String getURL(){
        return "areaPrivata/ssp/operazioni/compilaReferto.html";
    }
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        try {
            ...
            if (Utils.isNullOrEmpty(idPrescrizione_) || Utils.isNullOrEmpty(idPaziente_) || Utils.isNullOrEmpty(areaEsame)) {
                ...
                boolean refertoGenerato = sspDAO.generaReferto(referto,idPrescrizione,idPaziente,ssp.getId(),dataPagamento,1);
