...
/**
 * Handles the creation of a {@link Table}
 *
 * @author <a href="https://java.daypilot.org/lite/">DayPilot Lite (Open-Source)</a>
 */
public class TableLoader {

    static public Table load(ResultSet rs) throws SQLException {
        return load(rs, -1, -1);
    }

    static public Table load(ResultSet rs, int startRow, int maxRows) throws SQLException {
