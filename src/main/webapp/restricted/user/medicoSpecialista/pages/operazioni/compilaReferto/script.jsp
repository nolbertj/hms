...
<SCRIPT type="text/javascript">
    $(()=> {
        var idPaziente = undefined, pazienti = [], idPrescrizione = undefined, esami = [], URLs = {
            ...
            searchEsameURL:     '${cp}/<%=MedicoSpecialistaService.searchForSuggestionBoxURL()%>'
        ...
        boxEsame.select2({
            ...
            ajax: {
                ...
                type: "GET",
                url: (request)=> {
                    return URLs.searchEsameURL + idPaziente + '/esami/' + request.term;
                },
                processResults: (data)=> {
                    esami = data.results;
                    return {
        ...
        boxEsame.on('select2:select', (selection)=> {
            ...
            $("#medicoPrescrivente").attr('placeholder',esame["prescrivente"]);
        ...
        boxEsame.on('select2:unselect', ()=> {
            ...
            $("#medicoPrescrivente").attr('placeholder','');
