...
<c:url var="absolutePath" value="/restricted/user/medicoBase/pages/profilo" scope="page"/>
...
<custom:userInterface pageTitle="Profilo">
    ...
    <jsp:body>
        ...
        <div id="content">
            ...
            <!-- --------------- -->
            <br>
            <%@ include file="cards/ambulatorioCard.jsp" %>
            <br>
            <!-- MODIFICA PASSWORD -->
