...
origin2 AS(
   SELECT mb1.id, mb1.nome, mb1.cognome, mb1.data_nascita, mb1.sesso, a1.denominazione as nome_ambulatorio, a1.indirizzo as indirizzo_medico, a1.contatto_telefonico
   ...
   WHERE p.id = ? AND pm.al IS NULL
),
origin3 as(
   SELECT mb.id, mb.nome, mb.cognome, mb.data_nascita, mb.sesso, a.denominazione as nome_ambulatorio, a.indirizzo as indirizzo_medico, a.contatto_telefonico
...
---------------------------------------------------------------------
SELECT * from origin3
WHERE lower(origin3.nome) LIKE ? OR
